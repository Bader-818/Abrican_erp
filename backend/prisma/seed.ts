...
const PERMISSIONS: { key: string; description: string }[] = [
  ...
  { key: 'jobs.costing_view', description: 'View job costing and profitability' },
  { key: 'jobs.costing_review', description: 'Run job cost review and mark ready for invoice' },
  ...
  { key: 'dashboard.finance.view', description: 'View finance dashboard' },
  // Phase 2 — Finance
